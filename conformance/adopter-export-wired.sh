...
IGN="docs/ROADMAP-KIT.md .github/workflows/drift-watch.yml .github/workflows/golden-path.yml docs/superpowers/ .superpowers/ .github/CODEOWNERS docs/architecture/ docs/governance/meta-control-log.md docs/governance/.meta-control-last BACKLOG.md SPARKWRIGHT-CONSOLIDATED-BACKLOG.md"
