...
| 2 — Pure validator via TDD | In review | Eight witnessed RED→GREEN cycles; 26 validator tests; 100% statements/branches/functions/lines; commit pending independent review. |
